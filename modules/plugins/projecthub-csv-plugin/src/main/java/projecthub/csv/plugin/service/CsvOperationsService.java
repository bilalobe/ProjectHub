...
public class CsvOperationsService {
    ...
    public <T> void writeAll(String filePath, List<T> data, Class<T> type, String[] headers) {
        ...
        try (FileWriter writer = new FileWriter(filePath, StandardCharsets.UTF_8)) {
            ...
            logger.info("Successfully wrote {} records to {}", data.size(), filePath);
...
public class EnvironmentalMeasurement {
    private MetricValue quantitativeValue;
    private EcologicalContext context;
    private List<EcosystemImpact> potentialImpacts;
