...
public class ActivationStatus {
    ...
    public static final ActivationStatus ACTIVE = "ACTIVE";
    public static final ActivationStatus INACTIVE = "INACTIVE";
    public static final ActivationStatus PENDING = "PENDING";
