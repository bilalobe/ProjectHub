...
public class AppUserProfileController {
    ...
    public AppUserProfileController(final AppUserProfileService profileService) {
    ...
    @GetMapping
    public ResponseEntity<AppUserProfileDTO> getUserProfile(@RequestHeader("X-User-Id") final UUID userId) {
        AppUserProfileController.logger.info("Retrieving profile for user with ID: {}", userId);
        return ResponseEntity.ok(this.profileService.getUserProfileById(userId));
    }
    ...
    public ResponseEntity<AppUserProfileDTO> updateUserProfile(
        ...
        @Valid @RequestBody final UpdateUserRequestDTO updateRequest) {
        AppUserProfileController.logger.info("Updating profile for user with ID: {}", userId);
        return ResponseEntity.ok(this.profileService.updateUserProfile(userId, updateRequest));
    }
    ...
    public void updateAvatar(
        ...
        AppUserProfileController.logger.info("Updating avatar for user with ID: {}", userId);
        this.profileService.updateAvatar(userId, avatar);
    }
    ...
    public void updateStatus(
        ...
        AppUserProfileController.logger.info("Updating status for user with ID: {}", userId);
        this.profileService.updateStatus(userId, status);
    }
}
