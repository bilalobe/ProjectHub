...
public class AppUserCommandServiceImpl implements AppUserCommandService {
    ...
    public AppUserDTO createUser(final CreateUserDTO createUserDTO) {
        ...
        final RegisterRequestDTO registerRequest = AppUserCommandServiceImpl.convertToRegisterRequest(createUserDTO);
    ...
    public AppUserDTO updateUser(final UUID id, final AppUserDTO userDTO) {
        ...
        AppUser updatedUser = AppUserCommandServiceImpl.updateUserFields(existingUser, userDTO);
    ...
    private static RegisterRequestDTO convertToRegisterRequest(final CreateUserDTO userDTO) {
    ...
    private static AppUser updateUserFields(final AppUser user, final AppUserDTO userDTO) {
