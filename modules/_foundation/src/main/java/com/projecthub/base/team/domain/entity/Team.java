package com.projecthub.base.team.domain.entity;
...
import com.projecthub.base.shared.domain.enums.status.TeamStatus;
...
public class Team extends BaseEntity {
    ...
    public void assignPosition(int row, int column, TeamValidator validator) {
        TeamPosition newPosition = new TeamPosition(row, column);
        validator.validateTeamPosition(this, newPosition, this.getCohort().getSeatingConfig());
