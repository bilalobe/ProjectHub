...
public class AppUserValidationServiceImpl implements AppUserValidationService {
    ...
    @Override
    public void validateUpdate(final UpdateUserRequestDTO request, @NonNls final String currentUsername, @NonNls final String currentEmail) {
    ...
    @Override
    public void validateUniqueUsername(@NonNls final String username) {
    ...
    @Override
    public void validateUniqueEmail(@NonNls final String email) {
    ...
    private void validateConstraints(final Object request) {
        ...
        if (!violations.isEmpty()) {
            @NonNls final String errors = violations.stream()
                .map(v -> v.getPropertyPath() + ": " + v.getMessage())
                .reduce((@NonNls var a, var b) -> a + "; " + b)
                .orElse("");
