...
public class StorageConfig {
    ...
    public SyncService syncService(
        ...
        StorageConfig.logger.info("Initializing SyncService with {} synchronizers", Integer.valueOf(synchronizers.size()));
        return new SyncService(syncStatusTracker, networkChecker, synchronizers);
    }
}
