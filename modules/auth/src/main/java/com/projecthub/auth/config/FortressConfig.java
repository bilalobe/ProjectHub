 ...
 * gateway and auth services for making authorization decisions.</p>
 */
@Configuration
public class FortressConfig {
     ...
     */
    @Bean
    @ConditionalOnProperty(name = "projecthub.auth.fortress.enabled", havingValue = "true", matchIfMissing = true)
