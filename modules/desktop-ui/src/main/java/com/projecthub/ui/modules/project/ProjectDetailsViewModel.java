...
public class ProjectDetailsViewModel {
    ...
    private final ObservableList<MilestoneDTO> milestones = FXCollections.observableArrayList();
    ...
    public ObservableList<MilestoneDTO> getMilestones() {
        return milestones;
    }
    ...
    public void loadMilestones(UUID projectId) {
        try {
            List<MilestoneDTO> projectMilestones = projectService.getProjectMilestones(projectId);
            milestones.setAll(projectMilestones);
        } catch (Exception e) {
            logger.error("Failed to load milestones for project: {}", projectId, e);
        }
    }
